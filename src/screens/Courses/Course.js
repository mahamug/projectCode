...
import Courseflatlist from '../../components/Cource/courseflatlist';
...
const Course = ({route}) => {
  ...
  return (
    <View style={styles.container}>
      <DrawerNavbar title="Courses" navigation={navigation} />
      <Text style={styles.Text}>{courseName} Workout</Text>
      <FlatList
        showsVerticalScrollIndicator={false}
        key={'_'}
        data={data}
        renderItem={({item}) => {
          return <Courseflatlist item={item} />;
        }}
      />
    </View>
  );
